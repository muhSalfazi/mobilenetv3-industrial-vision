...
# CONFIG
VIDEOS = [
    '/media/Windows/project-python/Pre-Processing-ProjectTA/videos/rekamanCCTV-video1.mp4',
    '/media/Windows/project-python/Pre-Processing-ProjectTA/videos/rekamanCCTV-video2.mp4',
    '/media/Windows/project-python/Pre-Processing-ProjectTA/videos/rekamanCCTV-video3.mp4'
]
MODEL_PATH = "/media/Windows/project-python/Pre-Processing-ProjectTA/mobilenetv3_final_finetuned.keras"
OUTPUT_DIR = "/media/Windows/project-python/Pre-Processing-ProjectTA/customer_demos"
